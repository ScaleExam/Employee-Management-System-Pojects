...
<body class="bg-gradient-primary">
  ...
  <div class="container">
      ...
      <center><img src="logo.png" height="100dp"></center>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image"><img src="admin.png" height="255dp" style = "margin-left: 75px; margin-top: 55px;"></div>
              <div class="col-lg-6">
                <div class="p-5">
