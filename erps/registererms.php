...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    <center><img src="./img/logo.png" height="100dp"></center>

    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        <!-- Nested Row within Card Body -->
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block bg-register-image"><img src="./img/register.png" style = "margin-left: 75px; margin-top: 55px;"></div>
          <div class="col-lg-7">
            <div class="p-5">
